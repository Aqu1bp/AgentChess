...
Proposer + validator chess system where Codex plays black against a human.
...
- **AI:** Codex proposes moves from a grounded board brief, then a deterministic validator rejects blunders
